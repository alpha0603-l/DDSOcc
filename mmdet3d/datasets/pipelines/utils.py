...
try:
    ...
    raise ImportError("The 'utils.py' module requires 'numba' to be installed.")
box_np_ops = None
try:
...
def noise_per_object_v3_(
    ...
    if box_np_ops is None:
        raise ImportError("mmdet3d is required to use noise_per_object_v3_ (missing box_np_ops)")
