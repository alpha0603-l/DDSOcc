...
class PFNLayer(BaseModule):
    def __init__(self, in_channels, out_channels, norm_cfg=None, last_layer=False, init_cfg=None):
...
@MODELS.register_module()
class PointPillarsScatter(BaseModule):
    def __init__(self, in_channels=64, output_shape=(512, 512), init_cfg=None, **kwargs):
        super().__init__(init_cfg=init_cfg)
        self.in_channels = in_channels
...
@MODELS.register_module()
class PointPillarsEncoder(BaseModule):
    def __init__(
        self,
