...
try:
    ...
    def denormalize_bbox(bbox_pred, pc_range):
        raise ImportError("Cannot import denormalize_bbox from mmdet3d.core.bbox.util")
...
class NMSFreeCoder(BaseBBoxCoder):
    def __init__(
        ...
        super(NMSFreeCoder, self).__init__() # [增强] 初始化父类
    ...
    def decode_single(self, cls_scores, bbox_preds):
        ...
        if self.post_center_range is not None:
            # [Fix] Ensure tensor is on correct device
